...
%%  Ambient conditions
Amb.rho= 1.2245;                 % Air density[kg/m^3]
Amb.c0 = 340;              % speed of sound [m/s];
...
prop.rt = 0.1495;              % Propeller tip radius [m]
prop.hub = 0.11*0.1495;               % Propeller hub radius [m]
...
prop.thick_dist = 'parabolic';      % Three options - 'parabolic','uniform','custom' for thickness distrbution along the chord
...
prop.nu = 100;                  % No. of elements in the chorddirect   ion [-], relevant for 'custom' only
...
obs.theta =  (90).*(pi/180);     % observer angle in axial direction [rad]
